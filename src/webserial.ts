...
export class WebSerialManager {
    ...
    private processLine(line: string) {
        // Parse ESP32S3 JSON sensor output format - updated to include magnetometer and fusionMag:
        // {"accel":{"x":0.123,"y":0.456,"z":0.789},"gyro":{"x":1.23,"y":4.56,"z":7.89},"mag":{"x":0.12,"y":0.34,"z":0.56},"temp":25.4,"euler":{"roll":..,"pitch":..,"yaw":..},"fusionMag":{"roll":..,"pitch":..,"yaw":..},"t":123.456}
        ...
        try {
            ...
            // Validate JSON structure - updated to require mag and fusionMag
            if (jsonData.accel && jsonData.gyro && jsonData.mag && jsonData.gyroInt && 
                jsonData.fusion && jsonData.fusionMag && typeof jsonData.temp === 'number') {
                const sensorData: SensorData = {
                    ...
                    fusionMag: {
                        roll: jsonData.fusionMag.roll,
                        pitch: jsonData.fusionMag.pitch,
                        yaw: jsonData.fusionMag.yaw
                    },
